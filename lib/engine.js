 ...
 var Engine = function(gridW, gridH, cols, rols) {
     ...
     this.onDrag = function(event) {
         console.log("onDrag, state = " + this.eventsState.state + ", entity = " + (this.eventsState.currentDragEntity ? this.eventsState.currentDragEntity.id : " null "));
     ...
     this.invokeSubscribtionCallback = function(eventName, event, entity) {
         ...
         if (sub !== null) {
             sub.callback(xy.x - entity.x, xy.y - entity.y);
         }
     };
