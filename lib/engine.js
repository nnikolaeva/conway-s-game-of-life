 ...
 var Engine = function(gridW, gridH, cols, rols) {
     ...
     this.onDrag = function(event) {
         //console.log("onDrag, state = " + this.eventsState.state + ",  event type = " +  event.type + " entity = " + (this.eventsState.currentDragEntity ? this.eventsState.currentDragEntity.id : " null "));
     ...
     this.renderDragIcon = function(event) {
        var xy = this.translateToCanvasXY(event.clientX, event.clientY);
        var coords = [[0, -0.5], [-0.5, 0], [-0.5, 1], [0.5, 1], [0.5, -0.5], [0, -0.5]];
        var first = true;     
        var dx = 0.5;
        var dy = 0.5;
        var x;
